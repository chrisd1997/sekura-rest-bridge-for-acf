...
ACF REST Bridge securely exposes Advanced Custom Fields in the WordPress REST API. Based on [ACF to REST API](https://github.com/airesvsg/acf-to-rest-api) by Aires Goncalves, rebuilt with security as a first-class concern.
...
1. Upload the `acf-rest-bridge` folder to `/wp-content/plugins/`
...
Yes. ACF REST Bridge works alongside ACF Pro's native REST support and overrides it to provide consistent access control.
